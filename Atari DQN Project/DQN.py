...
def main():
    ...
    #     target_weight_update_freq = trial.suggest_categorical("target_weight_update_freq", [100, 150, 200, 300, 500]),
    #     replay_buffer_size = trial.suggest_categorical("replay_buffer_size", [500, 1000, 2000]),
    #     lr_begin    = trial.suggest_categorical("lr_begin", [0.00025, 0.005]),
    # )
    for i in range(10):
        config = NatureLinearConfig()
        env = TestEnv((80, 80, 1))
...
if __name__ == '__main__':
    ...
    # study = optuna.create_study(direction="maximize", storage=storage_url, study_name="Find_Best_Params_DQN_TestEnv", load_if_exists=True)
