...
class LinearConfig:
    ...
    def __init__(self, **kwargs):
        self.high                            = 255. # was 550. for smaller Dummy env    # using 950. for full DummyEnv ~70% accuracy     350. for TestEnv
        ...
        self.lr_begin                        = 0.005 # best performance was 0.05 I think bc full DummyEnv got 45% accuract and Smaller for 80%
        ...
        self.replay_buffer_size = 1000  # they use 1000
        self.gamma = 0.99
