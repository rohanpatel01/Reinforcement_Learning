...
class AtariDQNConfig:
    ...
    def __init__(self, **kwargs):
        ...
        self.record_freq = 20000 #250000   # Note: the way I coded it, for a recording to be made record_freq must equal eval_freq or at least be a common multiple. otherwise recording will not be made
        ...
        self.learning_start = 5000 # 50000
